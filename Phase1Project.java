...

{
   ...
   {
    	FILE_LOCATION = System.getProperty("user.dir");
        folder_name = new File(FILE_LOCATION+"/files");
        if (!folder_name.exists())
            folder_name.mkdirs();
        System.out.println("FILE_LOCATION: "+ folder_name.getAbsolutePath());
   System.out.println(WELCOME_PROMPT1); 
   }

       private static final String WELCOME_PROMPT1 =
    	        
       		"\n---------------------------Company Lockers Pvt.Ltd------------------------------------";
        private static final String WELCOME_PROMPT2 =
    ...
    public static void main(String[] args) 
    	...
    	{
            System.out.println(WELCOME_PROMPT2); 
